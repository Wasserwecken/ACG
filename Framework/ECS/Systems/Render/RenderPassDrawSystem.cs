...
//                    {
//                        _primitiveSpaceBlock.Data = CreatePrimitiveSpace(transformRelation.Key, renderData.ViewSpace.WorldToViewInverse, renderData.Projection);
...
//        /// 
//        /// </summary>
//        private ShaderPrimitiveSpace CreatePrimitiveSpace(TransformComponent primitiveTransform, Matrix4 viewSpaceInverse, Matrix4 projection)
//        {
//            return new ShaderPrimitiveSpace
//            {
//                LocalToWorld = primitiveTransform.WorldSpace,
//                LocalToView = primitiveTransform.WorldSpace * viewSpaceInverse,
//                LocalToProjection = primitiveTransform.WorldSpace * viewSpaceInverse * projection,

//                LocalToWorldRotation = primitiveTransform.WorldSpace.ClearScale(),
//                LocalToViewRotation = (primitiveTransform.WorldSpace * viewSpaceInverse).ClearScale().ClearTranslation(),
//                LocalToProjectionRotation = (primitiveTransform.WorldSpace * viewSpaceInverse).ClearScale().ClearTranslation() * projection,
//            };
//        }
