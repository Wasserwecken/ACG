...
//    public class RenderPassShadowSystemOLD : AEntitySetSystem<bool>
//    {
...
//        /// 
//        /// </summary>
//        public RenderPassShadowSystemOLD(World world, Entity worldComponents) : base(world)
//        {
...
//            {
//                renderView.FrameBuffer = new FramebufferAsset(shadowCaster.Resolution, shadowCaster.Resolution) { DrawMode = DrawBufferMode.None, ReadMode = ReadBufferMode.None };
