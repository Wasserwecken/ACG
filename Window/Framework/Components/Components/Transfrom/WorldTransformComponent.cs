...
namespace Framework
{
    ...
    {
        public static WorldTransformComponent Default => new WorldTransformComponent() { Space = Matrix4.Identity };
        ...
        /// 
        /// </summary>
        public WorldTransformComponent(Vector3 position)
        {
            this = Default;
            Position = position;
        }        
        ...
        /// 
        /// </summary>
        public WorldTransformComponent(Vector3 position, Vector3 forward)
        {
            this = Default;
            Position = position;
            Forward = forward;
